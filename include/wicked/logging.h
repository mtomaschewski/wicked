...
enum {
	NI_TRACE_IFCONFIG	= NI_BIT(0),
	NI_TRACE_READWRITE	= NI_BIT(1),
	NI_TRACE_XPATH		= NI_BIT(2),
	NI_TRACE_EXTENSION	= NI_BIT(3),
	NI_TRACE_WICKED		= NI_BIT(4),
	NI_TRACE_EVENTS		= NI_BIT(5),
	NI_TRACE_DHCP		= NI_BIT(6),
	NI_TRACE_IPV6		= NI_BIT(7),
	NI_TRACE_SOCKET		= NI_BIT(8),
	NI_TRACE_AUTOIP		= NI_BIT(9),
	NI_TRACE_WICKED_XML	= NI_BIT(10),
	NI_TRACE_DBUS		= NI_BIT(11),
	NI_TRACE_WIRELESS	= NI_BIT(12),
	NI_TRACE_XML		= NI_BIT(13),
	NI_TRACE_OBJECTMODEL	= NI_BIT(14),
	NI_TRACE_APPLICATION	= NI_BIT(15),
	NI_TRACE_MODEM		= NI_BIT(16),
	NI_TRACE_LLDP		= NI_BIT(17),
